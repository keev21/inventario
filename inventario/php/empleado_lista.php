...
<button class="button is-warning is-rounded" onclick="imprimirDiv()">Reporte empleados</button>
</div>
<br>
    ...
    if ($total >= 1 && $pagina <= $Npaginas) {
        ...
        foreach ($datos as $rows) {
            ...
            <td>' . $rows['email'] . '</td>
            <td>
                <a href="index.php?vista=empleado_update&empleado_id_up=' . $rows['id_cedula_empleado'] . '" class="button is-success is-rounded is-small">Actualizar</a>
            </td>
            <td>
                <a href="' . $url . $pagina . '&empleado_id_del=' . $rows['id_cedula_empleado'] . '" class="button is-danger is-rounded is-small">Eliminar</a>
            </td>
        </tr>
